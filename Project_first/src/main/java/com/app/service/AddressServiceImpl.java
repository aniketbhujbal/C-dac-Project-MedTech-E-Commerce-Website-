...
public class AddressServiceImpl implements AddressService {
    ...
    public Long createAddress(CreateAddressRequest createAddressRequest) {
        ...
        Optional<User> user =userrepo.findByUserName(createAddressRequest.getUserName());
	...
	@Override
	public GetAddressResponse findbyuserId(long userId) {
		
		AddressDao address=	addressRepository.findByuserId(userId);
