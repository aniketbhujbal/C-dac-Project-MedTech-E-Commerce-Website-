...
const ForgotPassword = () => {
    ...
    return (
      ...
      <MDBCard>
        ...
        <MDBCol md='2'></MDBCol>
          <MDBCol md='4'>
            <MDBCardImage src='https://previews.123rf.com/images/yuriybogdanov/yuriybogdanov1601/yuriybogdanov160100205/50709699-blue-medical-background-abstract-concept-health-care-or-medicine-technology-vector-illustration.jpg' 
