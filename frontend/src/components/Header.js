...
function Header() {
  ...
  return (
    ...
    <MDBContainer fluid>
      <MDBNavbarBrand href='/'>MEDTECH</MDBNavbarBrand>
      ...
      onSelect={handleSelect}
        >
              <Dropdown.Item eventKey="1">Consumable & Disposable</Dropdown.Item>
              <Dropdown.Item eventKey="2">Dental</Dropdown.Item>
              <Dropdown.Item eventKey="3">Medical Equipment</Dropdown.Item>
              <Dropdown.Divider />
      </NavDropdown>
          {/* <MDBNavbarItem>
