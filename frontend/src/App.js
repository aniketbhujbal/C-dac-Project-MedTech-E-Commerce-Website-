...
import PaymentReciept from './components/PaymentReciept';
    ...
    <div className="App">
       ...
       <hr></hr>
                <Routes>
                    ...
                    <Route path="/PrductDetails/:productId" element={<ProductDetails></ProductDetails>}></Route>
                    <Route path="/orderreciept" element={<PaymentReciept></PaymentReciept>}></Route>
